 ...
 */
final class Version20250112171857 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE character DROP CONSTRAINT FK_937AB0348F93B6FC');
        $this->addSql('DROP INDEX IDX_937AB0348F93B6FC');
        $this->addSql('ALTER TABLE character DROP movie_id');
    }
}
